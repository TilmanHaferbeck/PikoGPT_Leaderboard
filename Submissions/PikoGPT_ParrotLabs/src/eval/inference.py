...
def load_model_from_checkpoint(checkpoint_path: str, device: torch.device):
    ...
    # Submission checkpoints may omit lm_head.weight because ParrotLLM ties it
    # to tok_emb.weight at construction time. Loading non-strict keeps the
    # package below GitHub's 100 MB file limit without changing inference.
